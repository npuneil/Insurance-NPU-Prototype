@echo off
echo ╔══════════════════════════════════════════════════════════════╗
echo ║   Zava Insurance - On-Device AI Demo  SETUP                ║
echo ║   Snapdragon Edition  (Snapdragon X / QNN NPU)             ║
echo ╚══════════════════════════════════════════════════════════════╝
echo.
...
echo         Install Python 3.10+ (ARM64-native recommended) from https://python.org
...
echo ╔══════════════════════════════════════════════════════════════╗
echo ║   Setup complete!                                           ║
echo ║   Run StartApp.bat to launch the Snapdragon edition.       ║
echo ╚══════════════════════════════════════════════════════════════╝
echo.
pause
